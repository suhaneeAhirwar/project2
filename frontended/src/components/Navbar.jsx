...
function Navbar() {
  ...
  return () => {
    window.removeEventListener('scroll', handleScroll); // ✅ Correct usage
  };
}, []);
  ...
  return (
    ...
    <div>
      ...
      <div
       className={`navbar bg-base-80 shadow-sm  dark:bg-slate-900 dark:text-white  fixed top-0 left-0 right-0 z-50 ${
        sticky
...
<label className="swap swap-rotate">
  ...
  <input type="checkbox" className="grow outline-none dark:bg-slate-900 dark:text-white" value="synthwave" />
{/* theme-controller */}
  {/* sun icon */}
  <svg
...
<Login />  {/* Yeh hamesha render hoga, bas modal andar se control hoga */}
</div> 
)}
